...
{
  public class FormMetalMaster : Form
  {
    ...
    public FormMetalMaster() => this.InitializeComponent();

    private void FormMetalMaster_Load(object sender, EventArgs e)
    {
      this.refreshGrid();
    ...
    private void refreshGrid()
    {
      ...
      this.dataGridView1.DataSource = (object) MetalMaster.getCompleteMetalMasterTable("Metal");
    }
    ...
    {
      int num = (int) new FormMetalMasterAddEdit("ADD").ShowDialog();
      this.refreshGrid();
    }
    ...
    private void btnEdit_Click(object sender, EventArgs e)
    {
      if (this.dataGridView1 == null || this.dataGridView1.Rows.Count <= 0 || this.dataGridView1.CurrentCell == null || this.dataGridView1.CurrentCell.RowIndex < 0)
        return;
      int num = (int) new FormMetalMasterAddEdit("EDIT", this.dataGridView1.Rows[this.dataGridView1.CurrentCell.RowIndex].Cells["Metal"].Value.ToString()).ShowDialog();
      this.refreshGrid();
    }
    ...
    private void btnDelete_Click(object sender, EventArgs e)
    {
      if (this.dataGridView1 == null || this.dataGridView1.Rows.Count <= 0 || this.dataGridView1.CurrentCell == null || this.dataGridView1.CurrentCell.RowIndex < 0)
        return;
      string strMetal = this.dataGridView1.Rows[this.dataGridView1.CurrentCell.RowIndex].Cells["Metal"].Value.ToString();
      if (strMetal != "" && DialogResult.Yes == MessageBox.Show("Delete ?", "Delete?", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
      {
        MetalMaster.deleteThisMetal(strMetal);
        this.refreshGrid();
      }
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.label1.Size = new Size(189, 25);
      this.label1.TabIndex = 1;
      this.label1.Text = "METAL MASTER";
      ...
      this.panel2.Location = new Point(4, 38);
      this.panel2.Name = "panel2";
      this.panel2.Size = new Size(978, 471);
      this.panel2.TabIndex = 8;
      this.AutoScaleDimensions = new SizeF(6f, 13f);
      this.AutoScaleMode = AutoScaleMode.Font;
      this.ClientSize = new Size(986, 508);
      this.Controls.Add((Control) this.panel1);
      this.Controls.Add((Control) this.panel2);
      this.Name = nameof (FormMetalMaster);
      this.Text = "Metal Master";
      this.Load += new EventHandler(this.FormMetalMaster_Load);
