...
{
  public class FormPurityMaster : Form
  {
    ...
    public FormPurityMaster() => this.InitializeComponent();

    private void FormPurityMaster_Load(object sender, EventArgs e)
    {
      this.refreshGrid();
    ...
    private void refreshGrid()
    {
      ...
      this.dataGridView1.DataSource = (object) PurityMasterClass.getCompletePurityMasterTable("Purity");
    }
    ...
    {
      int num = (int) new FormPurityAddEdit("ADD").ShowDialog();
      this.refreshGrid();
    }
    ...
    private void btnEdit_Click(object sender, EventArgs e)
    {
      if (this.dataGridView1 == null || this.dataGridView1.Rows.Count <= 0 || this.dataGridView1.CurrentCell == null || this.dataGridView1.CurrentCell.RowIndex < 0)
        return;
      int num = (int) new FormPurityAddEdit("EDIT", this.dataGridView1.Rows[this.dataGridView1.CurrentCell.RowIndex].Cells["Purity"].Value.ToString()).ShowDialog();
      this.refreshGrid();
    }
    ...
    private void btnDelete_Click(object sender, EventArgs e)
    {
      if (this.dataGridView1 == null || this.dataGridView1.Rows.Count <= 0 || this.dataGridView1.CurrentCell == null || this.dataGridView1.CurrentCell.RowIndex < 0)
        return;
      string Purity = this.dataGridView1.Rows[this.dataGridView1.CurrentCell.RowIndex].Cells["Purity"].Value.ToString();
      if (Purity != "" && DialogResult.Yes == MessageBox.Show("Delete ?", "Delete?", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
      {
        PurityMasterClass.deleteRecordBasedOnThisPurity(Purity);
        this.refreshGrid();
      }
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.panel1.Location = new Point(15, 41);
      ...
      this.label1.Text = "PURITY MASTER";
      ...
      this.panel2.Location = new Point(15, 79);
      this.panel2.Name = "panel2";
      this.panel2.Size = new Size(978, 471);
      this.panel2.TabIndex = 10;
      this.AutoScaleDimensions = new SizeF(6f, 13f);
      this.AutoScaleMode = AutoScaleMode.Font;
      this.ClientSize = new Size(1008, 591);
      this.Controls.Add((Control) this.panel1);
      this.Controls.Add((Control) this.panel2);
      this.Name = nameof (FormPurityMaster);
      this.Text = nameof (FormPurityMaster);
      this.Load += new EventHandler(this.FormPurityMaster_Load);
