...
{
  public class FormPledgeAmountSummary : Form
  {
    ...
    public FormPledgeAmountSummary() => this.InitializeComponent();
    ...
    private void FormPledgeAmountSummary_Load(object sender, EventArgs e)
    {
    ...
    private void refreshGrid1()
    {
      ...
      if (this.cbShopCodes.Text != "")
        dataTable2 = SQLHelper.GetDataTable("(SELECT tp.ybd, sum(amountsum) as [Amount Sum] FROM ((select  billdate,sum(amount) as AmountSum ,month(billdate) as mbd,year(billdate) as ybd from  tblpledge p  where shopCode = @ShopCode group by billdate) AS tp) GROUP BY tp.ybd)", new List<OleDbParameter>()
        {
          new OleDbParameter("shopCode", (object) this.cbShopCodes.Text)
        }, ref strError);
      else
        dataTable2 = SQLHelper.GetDataTable("(SELECT tp.ybd, sum(amountsum) as [Amount Sum] FROM ((select  billdate,sum(amount) as AmountSum ,month(billdate) as mbd,year(billdate) as ybd from  tblpledge p group by billdate) AS tp) GROUP BY tp.ybd)", ref strError);
      ...
      if (this.dataGridView1.Rows.Count <= 0)
        return;
      this.dataGridView1.Columns["amount sum"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
    ...
    private void refreshGrid2(string YBD)
    {
      ...
      if (YBD == "")
      {
        if (this.cbShopCodes.Text != "")
        {
          string my_querry = "SELECT tp.ybd, tp.mbd,sum(AmountSum) as [Amount Sum] FROM (select  billdate,sum(amount) as AmountSum ,month(billdate) as mbd,year(billdate) as ybd from  tblpledge p where shopCode = @ShopCode group by billdate)  AS tp GROUP BY tp.ybd, tp.mbd";
          ...
          dataTable2 = SQLHelper.GetDataTable("SELECT tp.ybd, tp.mbd,sum(AmountSum) as [Amount Sum] FROM (select  billdate,sum(amount) as AmountSum ,month(billdate) as mbd,year(billdate) as ybd from  tblpledge p group by billdate)  AS tp GROUP BY tp.ybd, tp.mbd", ref strError);
      }
      else if (this.cbShopCodes.Text != "")
      {
        string my_querry = "select * from (SELECT tp.ybd, tp.mbd,sum(AmountSum) as [Amount Sum] FROM (select  billdate,sum(amount) as AmountSum ,month(billdate) as mbd,year(billdate) as ybd from  tblpledge p where shopCode = @ShopCode  group by billdate)  AS tp  GROUP BY tp.ybd, tp.mbd) where ybd = @YBD ";
        parameters.Add(new OleDbParameter("shopCode", (object) this.cbShopCodes.Text));
      ...
      {
        string my_querry = "select * from (SELECT tp.ybd, tp.mbd,sum(AmountSum) as [Amount Sum] FROM (select  billdate,sum(amount) as AmountSum ,month(billdate) as mbd,year(billdate) as ybd from  tblpledge p group by billdate)  AS tp  GROUP BY tp.ybd, tp.mbd) where ybd = @YBD ";
        parameters.Add(new OleDbParameter(nameof (YBD), (object) this.cbYearly1.Text.Trim()));
        dataTable2 = SQLHelper.GetDataTable(my_querry, parameters, ref strError);
      }
      ...
      if (this.dataGridView2.Rows.Count <= 0)
        return;
      this.dataGridView2.Columns["amount sum"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
    ...
    private void refreshGrid3(string MBD, string YBD)
    {
      ...
      if (MBD == "" && YBD == "")
      {
        if (this.cbShopCodes.Text == "")
        {
          dataTable = SQLHelper.GetDataTable("select billdate,sum(amount) as [Amount sum] ,month(billdate) as mbd,year(billdate) as ybd from  tblpledge p group by billdate order by billdate", ref strError);
        }
        else
        {
          string my_querry = "select billdate,sum(amount) as [Amount sum] ,month(billdate) as mbd,year(billdate) as ybd from  tblpledge p where shopcode = @ShopCode group by billdate order by billdate";
          parameters.Add(new OleDbParameter("shopCode", (object) this.cbShopCodes.Text));
      ...
      else if (MBD != "" && YBD != "")
      {
        if (this.cbShopCodes.Text == "")
        {
          string my_querry = " select * from (select billdate,sum(amount) as [Amount sum],month(billdate) as mbd,year(billdate) as ybd from  tblpledge p group by billdate) where mbd = @mbd and ybd = @ybd";
        ...
        {
          string my_querry = " select * from (select billdate,sum(amount) as [Amount sum],month(billdate) as mbd,year(billdate) as ybd from  tblpledge p where shopCode = @ShopCode group by billdate) where mbd = @mbd and ybd = @ybd";
          parameters.Add(new OleDbParameter("shopCode", (object) this.cbShopCodes.Text));
          parameters.Add(new OleDbParameter("mbd", (object) MBD));
          parameters.Add(new OleDbParameter("ybd", (object) YBD));
          dataTable = SQLHelper.GetDataTable(my_querry, parameters, ref strError);
      ...
      else if (MBD != "" && YBD == "")
      {
        if (this.cbShopCodes.Text == "")
        {
          string my_querry = " select * from (select billdate,sum(amount) as [Amount sum],month(billdate) as mbd,year(billdate) as ybd from  tblpledge p group by billdate) where mbd = @mbd";
          parameters.Add(new OleDbParameter("mbd", (object) MBD));
          dataTable = SQLHelper.GetDataTable(my_querry, parameters, ref strError);
        }
        else
        {
          string my_querry = " select * from (select billdate,sum(amount) as [Amount sum],month(billdate) as mbd,year(billdate) as ybd from  tblpledge p where shopCode = @ShopCode group by billdate) where mbd = @mbd";
          parameters.Add(new OleDbParameter("shopCode", (object) this.cbShopCodes.Text));
          parameters.Add(new OleDbParameter("mbd", (object) MBD));
          dataTable = SQLHelper.GetDataTable(my_querry, parameters, ref strError);
        }
      ...
      else if (MBD == "" && YBD != "")
      {
        if (this.cbShopCodes.Text == "")
        {
          string my_querry = " select * from (select billdate,sum(amount) as [Amount sum],month(billdate) as mbd,year(billdate) as ybd from  tblpledge p group by billdate) where ybd = @ybd";
          parameters.Add(new OleDbParameter("ybd", (object) YBD));
          dataTable = SQLHelper.GetDataTable(my_querry, parameters, ref strError);
        }
        else
        {
          string my_querry = " select * from (select billdate,sum(amount) as [Amount sum],month(billdate) as mbd,year(billdate) as ybd from  tblpledge p where shopCode = @ShopCode group by billdate) where ybd = @ybd";
          parameters.Add(new OleDbParameter("shopCode", (object) this.cbShopCodes.Text));
          parameters.Add(new OleDbParameter("ybd", (object) YBD));
          dataTable = SQLHelper.GetDataTable(my_querry, parameters, ref strError);
        }
      ...
      if (this.dataGridView3.Rows.Count <= 0)
        return;
      this.dataGridView3.Columns["amount sum"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
      this.dataGridView3.Columns[2].Visible = false;
      this.dataGridView3.Columns[3].Visible = false;
    }

    private void cbYearly2_SelectedIndexChanged(object sender, EventArgs e) => this.refreshGrid3(this.cbMonthly.Text.ToString(), this.cbYearly2.Text.Trim().ToString());
    ...
    private void InitializeComponent()
    {
      ...
      this.panel1.Size = new Size(330, 52);
      ...
      this.cbShopCodes.Size = new Size(328, 23);
      ...
      ((Control) this.glassButton9).Location = new Point(161, 512);
      ...
      this.panel2.Location = new Point(339, 3);
      this.panel2.Name = "panel2";
      this.panel2.Size = new Size(330, 52);
      ...
      ((Control) this.headerPanel1).Size = new Size(330, 52);
      ...
      ((Control) this.glassButton1).Location = new Point(25, 513);
      ...
      this.cbYearly1.Size = new Size(328, 26);
      ...
      ((Control) this.glassButton2).Location = new Point(159, 512);
      ...
      this.panel4.Location = new Point(675, 3);
      this.panel4.Name = "panel4";
      this.panel4.Size = new Size(330, 52);
      ...
      ((Control) this.glassButton5).Location = new Point(-153, 513);
      ...
      ((Control) this.glassButton6).Location = new Point(-19, 512);
      ...
      this.cbYearly2.Size = new Size(152, 26);
      ...
      ((Control) this.glassButton3).Location = new Point(-141, 513);
      ...
      ((Control) this.glassButton4).Location = new Point(-7, 512);
      ...
      this.cbMonthly.Size = new Size(164, 26);
      this.cbMonthly.TabIndex = 4;
      this.cbMonthly.SelectedIndexChanged += new EventHandler(this.cbYearly2_SelectedIndexChanged);
      ...
      this.dataGridView3.Location = new Point(675, 61);
      this.dataGridView3.Name = "dataGridView3";
      this.dataGridView3.ReadOnly = true;
      this.dataGridView3.Size = new Size(330, 568);
      ...
      this.dataGridView1.Size = new Size(330, 568);
      ...
      this.dataGridView2.Location = new Point(339, 61);
      this.dataGridView2.Name = "dataGridView2";
      this.dataGridView2.ReadOnly = true;
      this.dataGridView2.Size = new Size(330, 568);
      this.dataGridView2.TabIndex = 1;
      this.AutoScaleDimensions = new SizeF(96f, 96f);
      this.AutoScaleMode = AutoScaleMode.Dpi;
      this.ClientSize = new Size(1008, 632);
      this.Controls.Add((Control) this.tableLayoutPanel1);
      this.Name = nameof (FormPledgeAmountSummary);
      this.Text = nameof (FormPledgeAmountSummary);
      this.Load += new EventHandler(this.FormPledgeAmountSummary_Load);
