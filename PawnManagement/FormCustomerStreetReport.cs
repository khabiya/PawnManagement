...
{
  public class FormCustomerStreetReport : Form
  {
    ...
    public FormCustomerStreetReport() => this.InitializeComponent();
    ...
    private void refreshGrid()
    {
      ...
      string my_querry = !(this.comboBox1.Text == "PENDING") ? "select addr1 as [Street Name(addr1)], count(*) as [Number Of Bills],sum(amount) as Amount from tblpledge where (billdate between @date1 and @date2)" + str + " group by addr1" : "select addr1 as [Street Name(addr1)], count(*) as [Number Of Bills],sum(amount) as Amount from tblpledge where (billdate between @date1 and @date2) and redeemed = 'N' " + str + " group by addr1";
    ...
    {
      string strError = "";
      string my_querry = "select addr1  as [Street Name(addr1)], count(*) as [Number Of Bills],sum(amount) as Amount from tblpledge group by addr1";
      DataTable dataTable1 = new DataTable();
    ...
    private void exportToExcelToolStripMenuItem_Click(object sender, EventArgs e) => ExportToExcel.exportToExcel(this.dataGridView1, "Articles", FormMain.username);
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (FormCustomerStreetReport);
      this.StartPosition = FormStartPosition.CenterScreen;
      this.Text = nameof (FormCustomerStreetReport);
