...
namespace PawnManagement.pawnmanagementDataSet1TableAdapters
{
  ...
  public class tblUdhrathTableAdapter : Component
  {
    ...
    public tblUdhrathTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `tblUdhrath` (`ID`, `CustomerName`, `Description`, `Amount`, `jammaornovae`, `VoucherDate`, `CreatedOn`, `CreatedBy`) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
      this._adapter.InsertCommand.CommandType = CommandType.Text;
      this._adapter.InsertCommand.Parameters.Add(new OleDbParameter("ID", OleDbType.Integer, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ID", DataRowVersion.Current, false, (object) null));
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, CustomerName, Description, Amount, jammaornovae, VoucherDate, CreatedOn, CreatedBy FROM tblUdhrath";
    ...
    public virtual int Fill(
      pawnmanagementDataSet1.tblUdhrathDataTable dataTable)
    {
    ...
    public virtual pawnmanagementDataSet1.tblUdhrathDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      pawnmanagementDataSet1.tblUdhrathDataTable data = new pawnmanagementDataSet1.tblUdhrathDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(pawnmanagementDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "tblUdhrath");
      ...
      string CreatedBy)
    {
      ...
      if (CustomerName == null)
        ...
        this.Adapter.InsertCommand.Parameters[1].Value = (object) CustomerName;
      if (Description == null)
        this.Adapter.InsertCommand.Parameters[2].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[2].Value = (object) Description;
      if (Amount.HasValue)
        this.Adapter.InsertCommand.Parameters[3].Value = (object) Amount.Value;
      else
        this.Adapter.InsertCommand.Parameters[3].Value = (object) DBNull.Value;
      if (jammaornovae == null)
        this.Adapter.InsertCommand.Parameters[4].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[4].Value = (object) jammaornovae;
      if (VoucherDate.HasValue)
        this.Adapter.InsertCommand.Parameters[5].Value = (object) VoucherDate.Value;
      else
