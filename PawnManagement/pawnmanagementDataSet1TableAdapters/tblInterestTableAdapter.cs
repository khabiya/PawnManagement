...
namespace PawnManagement.pawnmanagementDataSet1TableAdapters
{
  ...
  public class tblInterestTableAdapter : Component
  {
    ...
    public tblInterestTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `tblInterest` (`Type`, `FromAmount`, `ToAmount`, `Chit`, `Interest`, `SymbolToDisplay`) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT SerialNumber, Type, FromAmount, ToAmount, Chit, Interest, SymbolToDisplay FROM tblInterest";
    ...
    public virtual int Fill(
      pawnmanagementDataSet1.tblInterestDataTable dataTable)
    {
    ...
    public virtual pawnmanagementDataSet1.tblInterestDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      pawnmanagementDataSet1.tblInterestDataTable data = new pawnmanagementDataSet1.tblInterestDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(pawnmanagementDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "tblInterest");
      ...
      string SymbolToDisplay)
    {
      ...
      if (FromAmount.HasValue)
        this.Adapter.InsertCommand.Parameters[1].Value = (object) FromAmount.Value;
      else
        this.Adapter.InsertCommand.Parameters[1].Value = (object) DBNull.Value;
      if (ToAmount.HasValue)
        this.Adapter.InsertCommand.Parameters[2].Value = (object) ToAmount.Value;
      else
        this.Adapter.InsertCommand.Parameters[2].Value = (object) DBNull.Value;
      if (Chit.HasValue)
        this.Adapter.InsertCommand.Parameters[3].Value = (object) Chit.Value;
      else
        this.Adapter.InsertCommand.Parameters[3].Value = (object) DBNull.Value;
      if (Interest.HasValue)
        this.Adapter.InsertCommand.Parameters[4].Value = (object) Interest.Value;
      else
        this.Adapter.InsertCommand.Parameters[4].Value = (object) DBNull.Value;
      if (SymbolToDisplay == null)
        this.Adapter.InsertCommand.Parameters[5].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[5].Value = (object) SymbolToDisplay;
