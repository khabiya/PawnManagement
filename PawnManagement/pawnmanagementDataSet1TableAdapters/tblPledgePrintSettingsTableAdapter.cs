...
namespace PawnManagement.pawnmanagementDataSet1TableAdapters
{
  ...
  public class tblPledgePrintSettingsTableAdapter : Component
  {
    ...
    public tblPledgePrintSettingsTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "tblPledgePrintSettings",
        ColumnMappings = {
          {
            "ID",
            "ID"
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `tblPledgePrintSettings` (`PrintFormats`, `PrintFormatsDefaultValue`, `PrintFormatsCustomerCopyDefaultValue`, `PrintPrompt`) VALUES (?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, PrintFormats, PrintFormatsDefaultValue, PrintFormatsCustomerCopyDefaultValue, PrintPrompt FROM tblPledgePrintSettings";
    ...
    public virtual int Fill(
      pawnmanagementDataSet1.tblPledgePrintSettingsDataTable dataTable)
    {
    ...
    public virtual pawnmanagementDataSet1.tblPledgePrintSettingsDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      pawnmanagementDataSet1.tblPledgePrintSettingsDataTable data = new pawnmanagementDataSet1.tblPledgePrintSettingsDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(pawnmanagementDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "tblPledgePrintSettings");
      ...
      string PrintPrompt)
    {
      ...
      if (PrintFormatsCustomerCopyDefaultValue == null)
        ...
        this.Adapter.InsertCommand.Parameters[2].Value = (object) PrintFormatsCustomerCopyDefaultValue;
      if (PrintPrompt == null)
        this.Adapter.InsertCommand.Parameters[3].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[3].Value = (object) PrintPrompt;
