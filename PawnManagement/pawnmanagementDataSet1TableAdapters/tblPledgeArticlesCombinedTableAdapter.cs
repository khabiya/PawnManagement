...
namespace PawnManagement.pawnmanagementDataSet1TableAdapters
{
  ...
  public class tblPledgeArticlesCombinedTableAdapter : Component
  {
    ...
    public tblPledgeArticlesCombinedTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "tblPledgeArticlesCombined",
        ColumnMappings = {
          {
            "ID",
            "ID"
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM `tblPledgeArticlesCombined` WHERE ((`ID` = ?) AND ((? = 1 AND `BillNumber` IS NULL) OR (`BillNumber` = ?)))";
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `tblPledgeArticlesCombined` (`BillNumber`, `Articles`) VALUES (?, ?)";
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE `tblPledgeArticlesCombined` SET `BillNumber` = ?, `Articles` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `BillNumber` IS NULL) OR (`BillNumber` = ?)))";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, BillNumber, Articles FROM tblPledgeArticlesCombined";
    ...
    public virtual int Fill(
      pawnmanagementDataSet1.tblPledgeArticlesCombinedDataTable dataTable)
    {
    ...
    public virtual pawnmanagementDataSet1.tblPledgeArticlesCombinedDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      pawnmanagementDataSet1.tblPledgeArticlesCombinedDataTable data = new pawnmanagementDataSet1.tblPledgeArticlesCombinedDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(pawnmanagementDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "tblPledgeArticlesCombined");
    ...
    public virtual int Delete(int Original_ID, string Original_BillNumber)
    {
    ...
    public virtual int Insert(string BillNumber, string Articles)
    {
      if (BillNumber == null)
      ...
      string Original_BillNumber)
    {
      ...
      if (Articles == null)
        ...
        this.Adapter.UpdateCommand.Parameters[1].Value = (object) Articles;
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[4].Value = (object) Original_BillNumber;
      }
