...
namespace PawnManagement.pawnmanagementDataSet1TableAdapters
{
  ...
  public class Paste_ErrorsTableAdapter : Component
  {
    ...
    public Paste_ErrorsTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `Paste Errors` (`ID`, `VoucherCode`, `VoucherName`, `LedgerCode`, `LedgerType`, `CreatedOn`, `CreatedBy`) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, VoucherCode, VoucherName, LedgerCode, LedgerType, CreatedOn, CreatedBy FROM [Paste Errors]";
    ...
    public virtual int Fill(
      pawnmanagementDataSet1.Paste_ErrorsDataTable dataTable)
    {
    ...
    public virtual pawnmanagementDataSet1.Paste_ErrorsDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      pawnmanagementDataSet1.Paste_ErrorsDataTable data = new pawnmanagementDataSet1.Paste_ErrorsDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(pawnmanagementDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "Paste Errors");
      ...
      string CreatedBy)
    {
      ...
      if (VoucherCode == null)
        ...
        this.Adapter.InsertCommand.Parameters[1].Value = (object) VoucherCode;
      if (VoucherName == null)
        this.Adapter.InsertCommand.Parameters[2].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[2].Value = (object) VoucherName;
      if (LedgerCode == null)
        this.Adapter.InsertCommand.Parameters[3].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[3].Value = (object) LedgerCode;
      if (LedgerType == null)
        this.Adapter.InsertCommand.Parameters[4].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[4].Value = (object) LedgerType;
