...
namespace PawnManagement.pawnmanagementDataSet1TableAdapters
{
  ...
  public class tblMetalMasterTableAdapter : Component
  {
    ...
    public tblMetalMasterTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM `tblMetalMaster` WHERE ((`ID` = ?) AND ((? = 1 AND `Metal` IS NULL) OR (`Metal` = ?)) AND ((? = 1 AND `ShortName` IS NULL) OR (`ShortName` = ?)) AND ((? = 1 AND `Description` IS NULL) OR (`Description` = ?)) AND ((? = 1 AND `EditedBy` IS NULL) OR (`EditedBy` = ?)) AND ((? = 1 AND `EditedOn` IS NULL) OR (`EditedOn` = ?)) AND ((? = 1 AND `CreatedBy` IS NULL) OR (`CreatedBy` = ?)) AND ((? = 1 AND `CreatedOn` IS NULL) OR (`CreatedOn` = ?)))";
      ...
      this._adapter.DeleteCommand.Parameters.Add(new OleDbParameter("IsNull_ShortName", OleDbType.Integer, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ShortName", DataRowVersion.Original, true, (object) null));
      this._adapter.DeleteCommand.Parameters.Add(new OleDbParameter("Original_ShortName", OleDbType.VarWChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ShortName", DataRowVersion.Original, false, (object) null));
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `tblMetalMaster` (`Metal`, `ShortName`, `Description`, `EditedBy`, `EditedOn`, `CreatedBy`, `CreatedOn`) VALUES (?, ?, ?, ?, ?, ?, ?)";
      ...
      this._adapter.InsertCommand.Parameters.Add(new OleDbParameter("ShortName", OleDbType.VarWChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ShortName", DataRowVersion.Current, false, (object) null));
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE `tblMetalMaster` SET `Metal` = ?, `ShortName` = ?, `Description` = ?, `EditedBy` = ?, `EditedOn` = ?, `CreatedBy` = ?, `CreatedOn` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Metal` IS NULL) OR (`Metal` = ?)) AND ((? = 1 AND `ShortName` IS NULL) OR (`ShortName` = ?)) AND ((? = 1 AND `Description` IS NULL) OR (`Description` = ?)) AND ((? = 1 AND `EditedBy` IS NULL) OR (`EditedBy` = ?)) AND ((? = 1 AND `EditedOn` IS NULL) OR (`EditedOn` = ?)) AND ((? = 1 AND `CreatedBy` IS NULL) OR (`CreatedBy` = ?)) AND ((? = 1 AND `CreatedOn` IS NULL) OR (`CreatedOn` = ?)))";
      ...
      this._adapter.UpdateCommand.Parameters.Add(new OleDbParameter("ShortName", OleDbType.VarWChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ShortName", DataRowVersion.Current, false, (object) null));
      ...
      this._adapter.UpdateCommand.Parameters.Add(new OleDbParameter("IsNull_ShortName", OleDbType.Integer, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ShortName", DataRowVersion.Original, true, (object) null));
      this._adapter.UpdateCommand.Parameters.Add(new OleDbParameter("Original_ShortName", OleDbType.VarWChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ShortName", DataRowVersion.Original, false, (object) null));
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, Metal, ShortName, Description, EditedBy, EditedOn, CreatedBy, CreatedOn FROM tblMetalMaster";
    ...
    public virtual int Fill(
      pawnmanagementDataSet1.tblMetalMasterDataTable dataTable)
    {
    ...
    public virtual pawnmanagementDataSet1.tblMetalMasterDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      pawnmanagementDataSet1.tblMetalMasterDataTable data = new pawnmanagementDataSet1.tblMetalMasterDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(pawnmanagementDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "tblMetalMaster");
      ...
      DateTime? Original_CreatedOn)
    {
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[4].Value = (object) Original_ShortName;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[8].Value = (object) Original_EditedBy;
      }
      if (Original_EditedOn.HasValue)
      {
        this.Adapter.DeleteCommand.Parameters[9].Value = (object) 0;
        this.Adapter.DeleteCommand.Parameters[10].Value = (object) Original_EditedOn.Value;
      }
      else
      {
      ...
      DateTime? CreatedOn)
    {
      ...
      if (ShortName == null)
        ...
        this.Adapter.InsertCommand.Parameters[1].Value = (object) ShortName;
      if (Description == null)
      ...
      if (EditedBy == null)
        ...
        this.Adapter.InsertCommand.Parameters[3].Value = (object) EditedBy;
      if (EditedOn.HasValue)
        this.Adapter.InsertCommand.Parameters[4].Value = (object) EditedOn.Value;
      else
      ...
      DateTime? Original_CreatedOn)
    {
      ...
      if (ShortName == null)
        ...
        this.Adapter.UpdateCommand.Parameters[1].Value = (object) ShortName;
      if (Description == null)
      ...
      if (EditedBy == null)
        ...
        this.Adapter.UpdateCommand.Parameters[3].Value = (object) EditedBy;
      if (EditedOn.HasValue)
        this.Adapter.UpdateCommand.Parameters[4].Value = (object) EditedOn.Value;
      else
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[9].Value = (object) Original_Metal;
      }
      if (Original_ShortName == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[11].Value = (object) Original_ShortName;
      }
      if (Original_Description == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[15].Value = (object) Original_EditedBy;
      }
      if (Original_EditedOn.HasValue)
      {
        this.Adapter.UpdateCommand.Parameters[16].Value = (object) 0;
        this.Adapter.UpdateCommand.Parameters[17].Value = (object) Original_EditedOn.Value;
      }
      else
      {
