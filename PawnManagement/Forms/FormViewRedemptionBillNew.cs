...
{
  public class FormViewRedemptionBillNew : Form
  {
    private string RedemptionBillNumber = "";
    ...
    public FormViewRedemptionBillNew(string REDEMPTIONBILLNUMBER, string SHOPCODE, string X)
    {
      this.x = X;
      this.RedemptionBillNumber = REDEMPTIONBILLNUMBER;
    ...
    private void FormViewRedemptionBillNew_Load(object sender, EventArgs e)
    {
      this.tbxRedemptionBillNumber.Text = this.RedemptionBillNumber;
      this.getPledgeBill();
    ...
    {
      string pledgeBillNumber = this.getPledgeBillNumber(this.RedemptionBillNumber);
      if (pledgeBillNumber != "")
      {
        string strError = "";
        ...
        else if (dataTable2 != null && dataTable2.Rows.Count > 0)
        {
          if (dataTable2.Rows[0].Field<string>("Redeemed") == "Y")
          {
            ...
            num = int.Parse(this.tbxAmount.Text.Trim().ToString()) * numberOfMonths * int.Parse(this.tbxInterestRate.Text.Trim().ToString()) / 1200;
            string str7 = num.ToString();
            tbxInterest.Text = str7;
    ...
    private void getReleasedBy()
    {
      ...
      List<OleDbParameter> parameters = new List<OleDbParameter>();
      parameters.Add(new OleDbParameter("BillNumber", (object) this.RedemptionBillNumber));
      parameters.Add(new OleDbParameter("ShopCode", (object) this.ShopCode));
      DataTable dataTable1 = new DataTable();
      DataTable dataTable2 = SQLHelper.GetDataTable(my_querry, parameters, ref strError);
      if (strError != "")
    ...
    private void tbxRedemptionBillNumber_TextChanged(object sender, EventArgs e) => this.getPledgeBill();
    ...
    private void InitializeComponent()
    {
      ...
      ((Control) this.glassButton17).Location = new Point(-136, 513);
      ...
      ((Control) this.btnSave).Location = new Point(-134, 513);
      ...
      ((Control) this.btnExit).Location = new Point(0, 512);
      ...
      ((Control) this.glassButton13).Location = new Point(-136, 513);
      ...
      ((Control) this.glassButton14).Location = new Point(-2, 512);
      ...
      ((Control) this.glassButton15).Location = new Point(-138, 513);
      ...
      ((Control) this.glassButton16).Location = new Point(-4, 512);
      ...
      this.tableLayoutPanel1.Size = new Size(1008, 551);
      ...
      this.panel3.Size = new Size(1002, 545);
      ...
      this.panel1.Size = new Size(992, 70);
      ...
      ((Control) this.glassButton9).Location = new Point(-133, 513);
      ...
      ((Control) this.glassButton10).Location = new Point(1, 512);
      ...
      this.tbxPledgeBillNumber.Font = new Font("Microsoft Sans Serif", 21.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
      ...
      this.tbxPledgeBillNumber.Size = new Size(174, 33);
      ...
      this.tbxShopCode.Font = new Font("Arial Rounded MT Bold", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
      this.tbxShopCode.ForeColor = Color.RoyalBlue;
      this.tbxShopCode.Location = new Point(8, 8);
      this.tbxShopCode.MaxLength = 6;
      this.tbxShopCode.Name = "tbxShopCode";
      this.tbxShopCode.Size = new Size(233, 16);
      ...
      ((Control) this.glassButton20).Location = new Point(-59, 513);
      ...
      ((Control) this.glassButton21).Location = new Point(75, 512);
      ...
      ((Control) this.glassButton6).Location = new Point(-56, 513);
      ...
      ((Control) this.glassButton7).Location = new Point(78, 512);
      ...
      this.tbxRedemptionBillNumber.Size = new Size(245, 33);
      ...
      ((Control) this.hpRedemptionDate).Location = new Point(262, 4);
      ...
      ((Control) this.hpRedemptionDate).Size = new Size(280, 56);
      ...
      ((Control) this.glassButton3).Location = new Point(-25, 513);
      ...
      ((Control) this.glassButton4).Location = new Point(109, 512);
      ...
      this.tbxRedemptionDate.Size = new Size(278, 33);
      ...
      ((Control) this.hpAuctionDate).Location = new Point(262, 4);
      ...
      ((Control) this.hpAuctionDate).Size = new Size(280, 56);
      ...
      this.tbxAuctionDate.Font = new Font("Microsoft Sans Serif", 9.75f, FontStyle.Bold, GraphicsUnit.Point, (byte) 0);
      ...
      this.tbxAuctionDate.Size = new Size(278, 15);
      ...
      ((Control) this.glassButton5).Location = new Point(-27, 513);
      ...
      ((Control) this.glassButton8).Location = new Point(107, 512);
      ...
      this.panel5.Location = new Point(636, 71);
      ...
      this.panel6.Location = new Point(5, 238);
      ...
      this.panel4.Location = new Point(5, 71);
      ...
      this.ClientSize = new Size(1008, 551);
      this.Controls.Add((Control) this.tableLayoutPanel1);
      this.Name = nameof (FormViewRedemptionBillNew);
      this.Text = nameof (FormViewRedemptionBillNew);
      this.Load += new EventHandler(this.FormViewRedemptionBillNew_Load);
