...
{
  public class FormViewCustomerOrder : Form
  {
    ...
    public FormViewCustomerOrder() => this.InitializeComponent();
    ...
    private void getListItems()
    {
      ...
      parameters.Add(new OleDbParameter("FormName", (object) "ViewCustomer"));
      ...
      else if (dataTable2 != null && dataTable2.Rows.Count > 0)
      {
        ...
        if (str1 == "")
          str1 = "p.shopCode,p.BillNumber,p.BillDate,p.Amount,p.BankCode,p.BankSerialNumber,p.articles,p.PresentValue ,p.GrossWeight,p.Deduction,p.NetWeight,p.temp1 as InterestRate,p.CustomerCode,p.customername as nameandaddress,P.PHONENUMBER,p.type";
        string str2 = str1;
    ...
    private void FormViewCustomerOrder_Load(object sender, EventArgs e) => this.getListItems();
    ...
    private void InitializeComponent()
    {
      ...
      this.panel1.Size = new Size(220, 32);
      ...
      this.label9.Location = new Point(171, 7);
      ...
      this.tableLayoutPanel1.Size = new Size(226, 628);
      ...
      this.panel2.Size = new Size(220, 584);
      ...
      this.ClientSize = new Size(226, 628);
      this.Controls.Add((Control) this.tableLayoutPanel1);
      this.FormBorderStyle = FormBorderStyle.None;
      this.Name = nameof (FormViewCustomerOrder);
      this.Text = nameof (FormViewCustomerOrder);
