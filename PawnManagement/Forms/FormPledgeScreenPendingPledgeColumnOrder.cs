...
{
  public class FormPledgeScreenPendingPledgeColumnOrder : Form
  {
    ...
    public FormPledgeScreenPendingPledgeColumnOrder() => this.InitializeComponent();
    ...
    private void getListItems()
    {
      ...
      parameters.Add(new OleDbParameter("FormName", (object) "PledgeScreenPendingPledge"));
      ...
      else if (dataTable2 != null && dataTable2.Rows.Count > 0)
      {
        ...
        if (str1 == "")
          str1 = "BillNumber,BillDate,Amount,temp1 as interestrate,PresentValue,GrossWeight,Deduction,NetWeight, articles,BankCode,BankSerialNumber,SHOPCODE,customerCode,customername as nameAndAddress,type";
        string str2 = str1;
        ...
        this.insertIntotblOrder("PledgeScreenPendingPledge", "BillNumber,BillDate,Amount,temp1 as interestrate,PresentValue,GrossWeight,Deduction,NetWeight, articles,BankCode,BankSerialNumber,SHOPCODE,customerCode,customername as nameAndAddress,type");
    }
    ...
    private void FormPledgeScreenPendingPledgeColumnOrder_Load(object sender, EventArgs e) => this.getListItems();
    ...
    private void InitializeComponent()
    {
      ...
      this.panel2.Size = new Size(215, 588);
      ...
      this.panel1.Size = new Size(215, 32);
      ...
      this.label9.Location = new Point(166, 7);
      ...
      this.tableLayoutPanel1.Size = new Size(221, 632);
      this.tableLayoutPanel1.TabIndex = 13;
      this.AutoScaleDimensions = new SizeF(6f, 13f);
      this.AutoScaleMode = AutoScaleMode.Font;
      this.ClientSize = new Size(221, 632);
      this.Controls.Add((Control) this.tableLayoutPanel1);
      this.FormBorderStyle = FormBorderStyle.None;
      this.Name = nameof (FormPledgeScreenPendingPledgeColumnOrder);
      this.StartPosition = FormStartPosition.CenterScreen;
      this.Text = nameof (FormPledgeScreenPendingPledgeColumnOrder);
      this.Load += new EventHandler(this.FormPledgeScreenPendingPledgeColumnOrder_Load);
