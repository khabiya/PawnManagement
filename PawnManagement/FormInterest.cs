...
{
  public class FormInterest : Form
  {
    ...
    private TextBox tbxSymbolToDisplay;
    ...
    public FormInterest() => this.InitializeComponent();
    ...
    {
      string strError = "";
      this.dtrefreshGrid = SQLHelper.GetDataTable("select * from tblInterest order by Type", ref strError);
      if (strError != "")
      {
    ...
    private void deleteToolStripMenuItem_Click(object sender, EventArgs e)
    {
      try
      {
        ...
        {
          string strError = "";
          if (SQLHelper.RunCommand("Delete from tblInterest where SerialNumber =@ID", new List<OleDbParameter>()
          {
    ...
    private void btnAddEdit_Click(object sender, EventArgs e)
    {
      try
      {
        ...
        if (((Control) this.btnAddEdit).Text == "UPDATE")
        {
          ...
          PawnManagementClass.InsertIntoHistory("INTEREST EDIT", "InTerest entry edited", this.oldValues, this.newValues, FormMain.username, DateTime.Now.ToString());
          this.editInterest();
        ...
        {
          PawnManagementClass.InsertIntoHistory("INTEREST ADD", "New interest entry added", "", "Type =" + this.cbType.Text.Trim().ToString() + ",\n FromAmount=" + this.tbxFromAmount.Text.Trim().ToString() + ",\n ToAmount=" + this.tbxToAmount.Text.Trim().ToString() + ",\n Interest=" + this.tbxInterest.Text.Trim().ToString() + ",\n Chit=" + this.tbxChit.Text.Trim().ToString() + ",\n SymbolToDisplay = " + this.tbxSymbolToDisplay.Text.Trim().ToString(), FormMain.username, DateTime.Now.ToString());
          this.addInterest();
          if (this.cbType.Items.Count > 0)
            this.cbType.SelectedIndex = 0;
          this.tbxFromAmount.Text = "";
    ...
    private bool checkIfAllTheEntriesAreMade()
    {
      ...
      {
        if (this.tbxFromAmount.Text.Trim() != "")
        {
          if (this.tbxToAmount.Text.Trim() != "")
          {
            if (this.tbxInterest.Text.Trim() != "")
            {
              if (this.tbxChit.Text.Trim() != "")
              {
                if (this.tbxSymbolToDisplay.Text.Trim() != "")
                {
                  if (double.Parse(this.tbxToAmount.Text) >= double.Parse(this.tbxFromAmount.Text))
                    return true;
                  this.tbxToAmount.Select();
                  return false;
                }
                this.tbxSymbolToDisplay.Select();
                return false;
              }
              this.tbxChit.Select();
              return false;
    ...
    private void editInterest()
    {
      try
      {
        ...
        int rowIndex = this.dataGridView1.CurrentCell.RowIndex;
        string strError = "";
        if (SQLHelper.RunCommand("Update tblInterest set Type=@Type,FromAmount=@FromAmount,ToAmount=@ToAmount,Chit =@Chit,Interest=@Interest,SymbolToDisplay=@SymbolToDisplay where SerialNumber =@SerialNumber", new List<OleDbParameter>()
        {
          ...
          new OleDbParameter("SymbolToDisplay", (object) this.tbxSymbolToDisplay.Text.Trim().ToString()),
    ...
    private void addInterest()
    {
      ...
      {
        string strError = "";
        if (!(SQLHelper.RunCommand("insert into tblInterest(Type,FromAmount,ToAmount,Chit,Interest,SymbolToDisplay) values(@Type,@FromAmount,@ToAmount,@Chit,@Interest,@SymbolToDisplay)", new List<OleDbParameter>()
        {
          new OleDbParameter("Type", (object) this.cbType.Text.ToString()),
          new OleDbParameter("FromAmount", (object) this.tbxFromAmount.Text.ToString()),
          new OleDbParameter("ToAmount", (object) this.tbxToAmount.Text.ToString()),
    ...
    private void InitializeComponent()
    {
      ...
      this.tbxSymbolToDisplay = new TextBox();
      ...
      this.tbxFromAmount.BackColor = Color.White;
      ...
      this.tbxToAmount.BackColor = Color.White;
      ...
      this.tbxInterest.BackColor = Color.White;
      ...
      this.tbxChit.BackColor = Color.White;
      ...
      this.tbxSymbolToDisplay.BackColor = Color.White;
      this.tbxSymbolToDisplay.BorderStyle = BorderStyle.FixedSingle;
      this.tbxSymbolToDisplay.Font = new Font("Verdana", 14.25f, FontStyle.Bold, GraphicsUnit.Point, (byte) 0);
      this.tbxSymbolToDisplay.Location = new Point(224, 518);
      this.tbxSymbolToDisplay.MaxLength = 2;
      this.tbxSymbolToDisplay.Name = "tbxSymbolToDisplay";
      this.tbxSymbolToDisplay.Size = new Size(227, 31);
      this.tbxSymbolToDisplay.TabIndex = 5;
      ...
      this.dataGridView1.Location = new Point(4, 6);
      this.dataGridView1.Name = "dataGridView1";
      this.dataGridView1.ReadOnly = true;
      this.dataGridView1.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
      this.dataGridView1.Size = new Size(713, 294);
      ...
      this.Controls.Add((Control) this.tbxSymbolToDisplay);
